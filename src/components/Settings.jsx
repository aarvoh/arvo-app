        ...
        <div className="section">
          ...
          <div className="group">
            ...
            <div className="row" style={{ cursor: 'pointer' }}>
              <div className="row-icon neutral"><svg viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6M15 3h6v6M10 14L21 3"/></svg></div>
              <div className="row-main"><div className="row-title">Open glass HUD</div><div className="row-sub">Open /glass in a new tab</div></div>
              <svg className="chevron" viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" onClick={() => window.open('/glass', '_blank')}><path d="M9 18l6-6-6-6"/></svg>
            </div>
          </div>
        </div>
